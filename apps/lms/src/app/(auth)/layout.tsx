...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative isolate min-h-[calc(100dvh-var(--header-height))] overflow-hidden py-10 sm:py-16">
      <RingBackdrop className="pointer-events-none absolute inset-0 -z-10" position="top-left" />
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-72 bg-gradient-to-b from-green-50/80 to-transparent" />
