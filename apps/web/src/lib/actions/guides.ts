 ...
 * Vérifie l'identité, la plateforme (site institutionnel) et le droit de lecture du guide, puis limite le
...
export async function submitGuideAssessmentAction(guideId: string, answers: GuideAnswers): Promise<AssessmentResult> {
  ...
  if (!guide || guide.platform !== 'web') throw new ForbiddenError('Ce guide est indisponible sur cette plateforme.')
