...
export const webAdministrateur: Guide = {
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  note: 'Rédigez toujours un message : c’est lui que reprend l’alerte de la page **Paramètres** (sans message, elle indique seulement « Un message de maintenance est affiché sur le site et la plateforme de formation. »).',
                },
                {
                  text: 'Cliquez sur `Enregistrer les paramètres`.',
                  result: 'L’alerte « Bandeau de maintenance actif » apparaît en haut de la page **Paramètres**.',
                },
                {
                  text: 'Contrôlez l’affichage sur le site public avec **Voir le site** (nouvel onglet).',
                  where: 'barre supérieure (sur mobile, depuis le tableau de bord)',
                  note: 'Si le bandeau n’apparaît pas sur le site alors que l’alerte est active dans **Paramètres**, signalez-le à l’équipe de développement (voir « Besoin d’aide ? »).',
                },
                {
  ...
  selfAssessment: {
    intro:
      'Quatorze questions pour vérifier que vous savez où agir dans le back-office, ce qui est irréversible et à qui vous adresser. Comptez sept minutes ; le corrigé renvoie à la section du guide.',
    passPercent: 70,
    questions: [
      {
        id: 'q-connexion-1',
        ...
        type: 'single',
        prompt: 'Vous avez perdu votre téléphone et vos codes de secours. Qui peut vous redonner accès à votre compte ?',
        options: [
          { id: 'a', text: 'Vous-même, depuis la page « Mot de passe oublié ? ».', correct: false },
          { id: 'b', text: 'Un autre super administrateur, avec le bouton `Réinitialiser la MFA` de votre fiche.', correct: true },
          { id: 'c', text: 'Le Support, depuis la page **Utilisateurs et rôles**.', correct: false },
        ],
        explanation: 'Seul un super administrateur peut réinitialiser la vérification en deux étapes d’un compte : voir « Activer votre vérification en deux étapes ».',
      },
      {
        id: 'q-reperer-1',
        sectionId: 'se-reperer',
        type: 'single',
        prompt: 'Sur un smartphone, comment ouvrez-vous la liste des sections du back-office ?',
        options: [
          { id: 'a', text: 'Avec le bouton **Ouvrir la navigation** (trois traits), en haut à gauche de la barre « Back-office ».', correct: true },
      ...
      },
      {
        ...
        type: 'true-false',
        prompt: 'Le mot de passe temporaire affiché à la création d’un compte est aussi envoyé par email à la personne.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'L’email ne contient qu’un lien « Définir mon mot de passe » valable 7 jours ; le mot de passe temporaire ne vous est affiché qu’une fois : voir « Créer un compte avec invitation par email ».',
      },
      {
        id: 'q-roles-1',
        sectionId: 'attribuer-un-role',
        type: 'single',
        prompt: 'Vous voulez qu’un formateur n’intervienne que sur une cohorte précise. Que choisissez-vous dans le dialogue « Attribuer un rôle » ?',
        options: [
          { id: 'a', text: 'Rôle « Formateur », portée « Globale (toute la plateforme) ».', correct: false },
          { id: 'b', text: 'Rôle « Formateur », portée « Une cohorte », puis la cohorte dans la liste **Choisir**.', correct: true },
          { id: 'c', text: 'Rôle « Coordinateur formation », portée « Une cohorte ».', correct: false },
        ],
        explanation: 'Un rôle limité s’attribue avec sa portée et l’élément choisi : voir « Attribuer un rôle ».',
      },
      {
        id: 'q-roles-2',
        sectionId: 'attribuer-et-revoquer-des-roles',
        type: 'true-false',
        prompt: 'Un rôle « Super administrateur » attribué avec la portée « Une organisation » donne les droits de super administrateur sur cette organisation.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Un super administrateur n’a de droits qu’en portée « Globale » ; toute autre portée est sans effet : voir « Comment attribuer et retirer des rôles ».',
      },
      {
        id: 'q-securiser-1',
        sectionId: 'desactiver-et-reactiver-un-compte',
        type: 'multiple',
        prompt: 'Que se passe-t-il quand vous cliquez sur `Désactiver le compte` puis `Désactiver` ?',
        options: [
          { id: 'a', text: 'La personne ne peut plus se connecter.', correct: true },
          { id: 'b', text: 'Ses sessions ouvertes sont fermées.', correct: true },
          { id: 'c', text: 'Ses certificats et ses commandes sont supprimés.', correct: false },
          { id: 'd', text: 'Elle reçoit un email l’informant de la désactivation.', correct: false },
        ],
        explanation: 'La désactivation bloque la connexion et ferme les sessions, mais conserve toutes les données et n’envoie aucun email : voir « Désactiver puis réactiver un compte ».',
      },
      {
        id: 'q-parametres-1',
        sectionId: 'parametres-en-lecture-seule',
        type: 'single',
        prompt: 'La coordination vous demande d’activer les « Forums de formation ». Que faites-vous ?',
        options: [
          { id: 'a', text: 'Vous cochez le drapeau dans la carte **Drapeaux fonctionnels** de la page **Paramètres**.', correct: false },
          { id: 'b', text: 'Vous demandez à la coordination formation de l’activer depuis son espace de coordination.', correct: false },
          { id: 'c', text: 'Vous adressez une demande écrite à l’exploitant, car la carte **Drapeaux fonctionnels** est en lecture seule.', correct: true },
        ],
        explanation: 'Les drapeaux fonctionnels sont affichés mais non modifiables dans le back-office : voir « Ce qui est affiché mais non modifiable ».',
      },
      {
        id: 'q-cles-1',
        sectionId: 'gerer-les-cles-api',
        type: 'single',
        prompt: 'Vous avez fermé le dialogue « Nouvelle clé API » sans copier la clé. Comment la récupérer ?',
        options: [
          { id: 'a', text: 'En cliquant sur son **Préfixe** dans le tableau.', correct: false },
          { id: 'b', text: 'Impossible : il faut révoquer cette clé et en générer une nouvelle.', correct: true },
          { id: 'c', text: 'En demandant à l’exploitant de la lire dans la base de données.', correct: false },
        ],
        explanation: 'Seule l’empreinte de la clé est conservée ; elle n’est affichée qu’une fois : voir « Comment gérer les clés API ».',
      },
      {
        id: 'q-traitements-1',
        sectionId: 'relancer-ou-annuler-une-tache',
        type: 'single',
        prompt: 'Quelles tâches peuvent être relancées avec le bouton `Relancer` ?',
        options: [
          { id: 'a', text: 'Les tâches « En échec » et « Abandonnée ».', correct: true },
          { id: 'b', text: 'Toutes les tâches, y compris « Réussi ».', correct: false },
          { id: 'c', text: 'Seulement les tâches « En file d’attente ».', correct: false },
        ],
        explanation: '`Relancer` remet en file une tâche en échec ou abandonnée, tentatives à zéro : voir « Relancer ou annuler une tâche ».',
      },
      {
        id: 'q-traitements-2',
        sectionId: 'diagnostiquer-les-emails',
        type: 'single',
        prompt: 'L’**État de santé** indique le fournisseur d’email « console ». Qu’est-ce que cela signifie ?',
        options: [
          { id: 'a', text: 'Les emails partent normalement par le service de la Fédération.', correct: false },
          { id: 'b', text: 'Aucun email n’est réellement envoyé : c’est un réglage de test à corriger par l’exploitant.', correct: true },
          { id: 'c', text: 'Les emails sont envoyés mais sans expéditeur.', correct: false },
        ],
        explanation: 'Le fournisseur « console » n’envoie rien ; il faut « resend » ou « smtp » : voir « Diagnostiquer les emails non délivrés ».',
      },
      {
        id: 'q-audit-1',
        sectionId: 'consulter-le-journal-d-audit',
        type: 'true-false',
        prompt: 'Un super administrateur peut supprimer une entrée du journal d’audit depuis le back-office.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Le journal est immuable : on le filtre et on l’exporte, rien de plus. Chaque export est lui-même journalisé : voir « Comment consulter le journal d’audit ».',
      },
      {
        id: 'q-securite-1',
        sectionId: 'rotation-des-secrets',
        type: 'single',
        prompt: 'Où se renouvellent les secrets techniques (accès à la base de données, clé du service d’email) ?',
        options: [
          { id: 'a', text: 'Dans la page **Paramètres** du back-office.', correct: false },
          { id: 'b', text: 'Dans les variables d’environnement de l’hébergeur, avec l’exploitant et le runbook « rotation-secrets ».', correct: true },
          { id: 'c', text: 'Dans la carte **Clés API**.', correct: false },
        ],
        explanation: 'Seules les clés API des partenaires se gèrent dans l’interface ; les autres secrets vivent chez l’hébergeur : voir « Renouveler les secrets techniques ».',
      },
      {
        id: 'q-gouvernance-1',
        sectionId: 'deleguer-et-gouverner',
        type: 'single',
        prompt: 'Une personne doit publier les actualités et gérer les médias du site. Quel rôle lui attribuez-vous ?',
        options: [
          { id: 'a', text: 'Éditeur communication.', correct: true },
          { id: 'b', text: 'Responsable services.', correct: false },
          { id: 'c', text: 'Super administrateur, pour qu’elle ne soit jamais bloquée.', correct: false },
        ],
        explanation: 'Donnez le rôle le plus bas qui suffit ; les contenus reviennent à l’Éditeur communication : voir « Comment déléguer : quel rôle pour quelle tâche ».',
      },
      {
        id: 'q-sensibles-1',
        sectionId: 'operations-sensibles',
        type: 'multiple',
        prompt: 'Parmi ces opérations, lesquelles ne peuvent pas être annulées après confirmation ?',
        options: [
          { id: 'a', text: 'Révoquer une clé API.', correct: true },
          { id: 'b', text: 'Définir un mot de passe temporaire.', correct: true },
          { id: 'c', text: 'Désactiver un compte.', correct: false },
          { id: 'd', text: 'Révoquer un rôle.', correct: false },
        ],
        explanation: 'Une clé révoquée l’est pour toujours et l’ancien mot de passe est perdu ; un compte se réactive et un rôle se réattribue : voir « Opérations sensibles et irréversibles ».',
      },
    ],
  },
}
