...
export const webEditeur: Guide = {
  ...
  selfAssessment: {
    intro:
      'Vingt et une questions pour vérifier que vous savez où cliquer, ce que signifie chaque statut, ce qui est irréversible et à qui vous adresser. Comptez dix minutes ; le corrigé renvoie à la section du guide.',
    passPercent: 70,
    questions: [
      {
        id: 'q-role-1',
        ...
        type: 'single',
        prompt: 'Quel contenu ne pouvez-vous pas modifier avec le rôle « Éditeur communication » ?',
        options: [
          { id: 'a', text: 'Une actualité déjà publiée.', correct: false },
          { id: 'b', text: 'Une fiche du catalogue des services.', correct: true },
          { id: 'c', text: 'Une question fréquente masquée.', correct: false },
          { id: 'd', text: 'Le logo d’un partenaire.', correct: false },
        ],
        explanation: 'Les services s’ouvrent en lecture seule : seule l’équipe des services les modifie. Voir « Votre rôle en bref ».',
      },
      {
        id: 'q-mfa-1',
        ...
        options: [
          { id: 'a', text: 'Dans le menu de votre compte (vos initiales), rubrique **Sécurité**.', correct: true },
          { id: 'b', text: 'Dans le tableau de bord du back-office, carte « Messages reçus ».', correct: false },
          { id: 'c', text: 'Dans le menu **Rapports**.', correct: false },
        ],
        explanation: 'La page « Protéger mon compte » se trouve sous **Sécurité**. Voir « Activer la vérification en deux étapes ».',
      },
      {
        id: 'q-mfa-2',
        sectionId: 'activer-la-verification-en-deux-etapes',
        type: 'true-false',
        prompt: 'Les codes de secours peuvent être réaffichés plus tard depuis la page « Protéger mon compte ».',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Ils sont affichés une seule fois. Pour en obtenir de nouveaux, il faut désactiver puis réactiver la vérification. Voir « Activer la vérification en deux étapes ».',
      },
      {
        id: 'q-reperer-1',
        sectionId: 'se-reperer',
        type: 'single',
        prompt: 'Sur téléphone, comment ouvrez-vous la navigation du back-office ?',
        options: [
          { id: 'a', text: 'Avec le bouton **Ouvrir la navigation** (trois traits), en haut à gauche.', correct: true },
          { id: 'b', text: 'En balayant l’écran vers le bas.', correct: false },
          { id: 'c', text: 'Avec le lien « Voir le site ».', correct: false },
        ],
        explanation: 'Sous 1024 pixels, le menu de gauche devient un tiroir ouvert par ce bouton. Voir « Se repérer dans le back-office ».',
      },
      {
        id: 'q-cycle-1',
        sectionId: 'cycle-de-publication',
        type: 'multiple',
        prompt: 'Quels statuts rendent un contenu invisible pour les visiteurs du site ?',
        options: [
          { id: 'a', text: 'Brouillon', correct: true },
          { id: 'b', text: 'En relecture', correct: true },
          { id: 'c', text: 'Publié', correct: false },
          { id: 'd', text: 'Archivé', correct: true },
        ],
        explanation: 'Seul « Publié » est visible sur le site ; « Planifié » le devient à l’heure choisie. Voir « Comprendre le cycle de publication ».',
      },
      {
        id: 'q-cycle-2',
        sectionId: 'cycle-de-publication',
        type: 'true-false',
        prompt: 'Une fenêtre de confirmation s’affiche avant que le contenu soit publié quand vous cliquez sur `Publier`.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Publier, archiver et repasser en brouillon sont immédiats ; seules la planification et la suppression ouvrent un dialogue. Voir « Comprendre le cycle de publication ».',
      },
      {
        id: 'q-planifier-1',
        sectionId: 'planifier-une-publication',
        type: 'single',
        prompt: 'Quels contenus peuvent être planifiés à une date de publication ?',
        options: [
          { id: 'a', text: 'Les pages et les actualités seulement.', correct: true },
          { id: 'b', text: 'Tous les contenus, y compris les ressources et les événements.', correct: false },
          { id: 'c', text: 'Les événements seulement.', correct: false },
        ],
        explanation: 'La planification n’existe que pour les pages et les actualités. Voir « Planifier une publication ».',
      },
      {
        id: 'q-previsualiser-1',
        sectionId: 'previsualiser',
        type: 'single',
        prompt: 'Vous avez publié une actualité et constatez une grosse erreur. Que faites-vous en premier ?',
        options: [
          { id: 'a', text: '`Actions` puis `Supprimer` : l’actualité disparaît du site.', correct: false },
          { id: 'b', text: '`Actions` puis `Repasser en brouillon`, puis corriger et republier.', correct: true },
          { id: 'c', text: 'Rien : la correction n’est possible qu’après 24 heures.', correct: false },
        ],
        explanation: 'Repasser en brouillon retire aussitôt le contenu du site sans rien perdre ; la suppression est définitive. Voir « Prévisualiser avant de publier ».',
      },
      {
        id: 'q-image-1',
        sectionId: 'mettre-en-forme-le-texte',
        type: 'single',
        prompt: 'Dans le dialogue « Insérer une image », pourquoi le choix du fichier est-il désactivé ?',
        options: [
          { id: 'a', text: 'Le champ **Texte alternatif** est encore vide.', correct: true },
          { id: 'b', text: 'La médiathèque est pleine.', correct: false },
          { id: 'c', text: 'Vous n’avez pas le droit d’insérer des images.', correct: false },
        ],
        explanation: 'Le texte alternatif est obligatoire avant l’envoi : « Renseignez d’abord le texte alternatif. » Voir « Mettre en forme le texte ».',
      },
      {
        id: 'q-slug-1',
        sectionId: 'classer-et-illustrer-une-actualite',
        type: 'true-false',
        prompt: 'Changer le slug d’une actualité déjà partagée redirige automatiquement les anciens liens vers la nouvelle adresse.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Aucune redirection n’est créée : les anciens liens mènent à une page introuvable. Voir « Classer, illustrer et référencer l’actualité ».',
      },
      {
        id: 'q-versions-1',
        sectionId: 'restaurer-une-version',
        type: 'single',
        prompt: 'Que se passe-t-il quand vous restaurez une ancienne version d’une page ?',
        options: [
          { id: 'a', text: 'Les versions plus récentes sont effacées.', correct: false },
          { id: 'b', text: 'Une nouvelle version est créée avec l’ancien contenu ; rien n’est supprimé.', correct: true },
          { id: 'c', text: 'La page est automatiquement archivée.', correct: false },
        ],
        explanation: 'La restauration crée une version supplémentaire et ne change pas le statut. Voir « Restaurer une version précédente ».',
      },
      {
        id: 'q-ressource-1',
        sectionId: 'deposer-une-ressource',
        type: 'single',
        prompt: 'Quel niveau d’accès choisir pour un procès-verbal nominatif destiné aux seuls membres d’une organisation ?',
        options: [
          { id: 'a', text: 'Public', correct: false },
          { id: 'b', text: 'Organisation, avec l’organisation rattachée renseignée.', correct: true },
          { id: 'c', text: 'Premium', correct: false },
        ],
        explanation: 'Le niveau Organisation réserve le fichier aux membres de l’organisation rattachée ; sans organisation rattachée, toutes les organisations y accèdent. Voir « Comment déposer une ressource documentaire ».',
      },
      {
        id: 'q-mediatheque-1',
        sectionId: 'mediatheque',
        type: 'single',
        prompt: 'Quelle est la taille maximale réellement acceptée pour une image dans la médiathèque ?',
        options: [
          { id: 'a', text: '8 Mo', correct: true },
          { id: 'b', text: '12 Mo', correct: false },
          { id: 'c', text: '25 Mo', correct: false },
        ],
        explanation: 'Le dialogue annonce 12 Mo mais la limite appliquée aux images est 8 Mo (25 Mo pour les documents). Voir « Comment gérer la médiathèque ».',
      },
      {
        id: 'q-categories-1',
        sectionId: 'gerer-les-categories',
        type: 'true-false',
        prompt: 'Une catégorie encore utilisée par des contenus peut être supprimée : les contenus passent alors « Sans catégorie ».',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'La suppression est refusée tant que des contenus utilisent la catégorie. Voir « Comment gérer les catégories ».',
      },
      {
        id: 'q-participants-1',
        sectionId: 'suivre-les-participants',
        type: 'single',
        prompt: 'Le jour de l’événement, quel bouton marque la présence d’une personne inscrite ?',
        options: [
          { id: 'a', text: '`Présent`, dans la colonne « Présence » de la carte « Participants ».', correct: true },
          { id: 'b', text: '`Publier`, dans le panneau « Publication ».', correct: false },
          { id: 'c', text: '`Exporter (CSV)`.', correct: false },
        ],
        explanation: 'Seuls les participants « Inscrit » peuvent être marqués présents ; `Retirer` annule. Voir « Suivre les inscrits, marquer les présences et exporter ».',
      },
      {
        id: 'q-partenaire-1',
        sectionId: 'gerer-les-partenaires',
        type: 'single',
        prompt: 'Une relation avec un partenaire est suspendue. Que faites-vous ?',
        options: [
          { id: 'a', text: 'Décocher **Visible sur le site** puis `Enregistrer`.', correct: true },
          { id: 'b', text: 'Cliquer sur `Supprimer le partenaire`.', correct: false },
          { id: 'c', text: 'Envoyer la fiche en relecture.', correct: false },
        ],
        explanation: 'Masquer conserve la fiche ; la suppression est définitive. Les partenaires n’ont pas de cycle de publication. Voir « Comment ajouter ou masquer un partenaire ».',
      },
      {
        id: 'q-messages-1',
        sectionId: 'traiter-les-messages-recus',
        type: 'multiple',
        prompt: 'Quels messages reçus peuvent être supprimés ?',
        options: [
          { id: 'a', text: 'Un message « Clôturé ».', correct: true },
          { id: 'b', text: 'Un message « Indésirable ».', correct: true },
          { id: 'c', text: 'Un message « Nouveau ».', correct: false },
          { id: 'd', text: 'Un message « Attribué ».', correct: false },
        ],
        explanation: 'Seuls les statuts Indésirable et Clôturé autorisent la suppression, qui est définitive. Voir « Comment traiter un message reçu depuis le site ».',
      },
      {
        id: 'q-newsletter-1',
        sectionId: 'gerer-la-newsletter',
        type: 'true-false',
        prompt: 'Le back-office permet d’envoyer la lettre d’information aux abonnés confirmés.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Le back-office gère seulement la liste, l’export CSV des consentements et la suppression ; l’envoi se fait avec un outil externe. Voir « Comment gérer les abonnés à la lettre d’information ».',
      },
      {
        id: 'q-supprimer-1',
        sectionId: 'supprimer-un-contenu',
        type: 'single',
        prompt: 'Pour retirer du site un événement passé sans perdre la liste de ses inscrits, vous choisissez :',
        options: [
          { id: 'a', text: '`Archiver`', correct: true },
          { id: 'b', text: '`Supprimer définitivement`', correct: false },
          { id: 'c', text: '`Exporter (CSV)`', correct: false },
        ],
        explanation: 'La suppression emporte les inscriptions ; l’archivage retire du site en conservant tout. Voir « Comment supprimer un contenu (et quand ne pas le faire) ».',
      },
      {
        id: 'q-securite-1',
        sectionId: 'bonnes-pratiques',
        type: 'single',
        prompt: 'Vous recevez l’email « Votre mot de passe FETRAG a été modifié » sans l’avoir demandé. Que faites-vous ?',
        options: [
          { id: 'a', text: 'Vous changez immédiatement votre mot de passe et prévenez le super administrateur.', correct: true },
          { id: 'b', text: 'Vous ignorez l’email : c’est un message automatique sans importance.', correct: false },
          { id: 'c', text: 'Vous répondez à l’email en indiquant votre mot de passe actuel.', correct: false },
        ],
        explanation: 'Un changement que vous n’avez pas fait signale un accès non autorisé. Voir « Bonnes pratiques éditoriales et sécurité ».',
      },
      {
        id: 'q-aide-1',
        sectionId: 'besoin-d-aide',
        type: 'single',
        prompt: 'À qui demander la réinitialisation de votre vérification en deux étapes quand vous n’avez plus ni téléphone ni code de secours ?',
        options: [
          { id: 'a', text: 'Au super administrateur.', correct: true },
          { id: 'b', text: 'Au responsable des services.', correct: false },
          { id: 'c', text: 'À la coordination formation.', correct: false },
        ],
        explanation: 'La réinitialisation de la vérification en deux étapes relève du super administrateur. Voir « Besoin d’aide ? ».',
      },
    ],
  },
  related: [
