...
export const webCoordination: Guide = {
              ...
              items: [
                {
                  ...
                  result:
                    'Le bouton indique « Déconnexion en cours », puis le site revient à la page d’accueil : le bouton `Espace personnel` remplace votre avatar.',
                  note: 'Si vous arrivez sur la page « Se déconnecter ? » (par un lien de déconnexion), cliquez sur `Confirmer la déconnexion` ; la page « Vous êtes déconnecté » s’affiche alors.',
                },
                {
  ...
  selfAssessment: {
    intro:
      'Vingt questions pour vérifier que vous savez où agir (sur le site ou sur la plateforme), ce qui est réversible et à qui vous adresser. Comptez dix minutes ; le corrigé renvoie à la section du guide.',
    passPercent: 70,
    questions: [
      {
        id: 'q-role-1',
        ...
        type: 'single',
        prompt: 'Où prenez-vous la décision (accepter, refuser, demander un complément) sur une demande de formation ?',
        options: [
          { id: 'a', text: 'Sur la fiche de l’organisation, dans le back-office du site.', correct: false },
          { id: 'b', text: 'Sur la plateforme de formation, dans votre espace de coordination.', correct: true },
          { id: 'c', text: 'Sur la page « Rapports » du site.', correct: false },
        ],
        explanation: 'Le site ne fait que montrer l’état des demandes ; les décisions se prennent sur la plateforme. Voir « Votre rôle en bref ».',
      },
      {
        id: 'q-role-2',
        sectionId: 'votre-role',
        type: 'multiple',
        prompt: 'Parmi ces actions, lesquelles vous sont interdites sur le site ?',
        options: [
          { id: 'a', text: 'Attribuer un rôle à un compte.', correct: true },
          { id: 'b', text: 'Rembourser une commande.', correct: true },
          { id: 'c', text: 'Rattacher un compte existant à une organisation.', correct: false },
          { id: 'd', text: 'Accorder une prise en charge.', correct: true },
        ],
        explanation: 'Les rôles relèvent du super administrateur, le remboursement et les prises en charge du rôle Finance. Le rattachement d’un membre vous est ouvert. Voir « Votre rôle en bref ».',
      },
      {
        id: 'q-connexion-1',
        sectionId: 'se-connecter',
        type: 'single',
        prompt: 'Quel lien du menu du compte ouvre le back-office du site ?',
        options: [
          { id: 'a', text: '**Mon espace**', correct: false },
          { id: 'b', text: '**Administration du site**', correct: true },
          { id: 'c', text: '**Plateforme de formation**', correct: false },
        ],
        explanation: '**Administration du site** mène au tableau de bord « Bonjour {prénom} ». Voir « Se connecter au site ».',
      },
      {
        id: 'q-connexion-2',
        sectionId: 'activer-la-verification-en-deux-etapes',
        type: 'true-false',
        prompt: 'Un code de secours peut être utilisé plusieurs fois.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Chaque code de secours ne sert qu’une fois ; conservez-les hors du téléphone. Voir « Activer la vérification en deux étapes ».',
      },
      {
        id: 'q-deconnexion-1',
        sectionId: 'se-deconnecter',
        type: 'true-false',
        prompt: 'La déconnexion sur le site vous déconnecte aussi de la plateforme de formation.',
        options: [
          { id: 'a', text: 'Vrai', correct: true },
          { id: 'b', text: 'Faux', correct: false },
        ],
        explanation: 'Le compte est le même sur les deux plateformes. Voir « Se déconnecter ».',
      },
      {
        id: 'q-reperer-1',
        sectionId: 'se-reperer',
        type: 'single',
        prompt: 'Sur un téléphone, comment ouvrir la rubrique **Organisations** du back-office ?',
        options: [
          { id: 'a', text: 'Avec le bouton **Ouvrir la navigation** (trois traits) en haut à gauche, puis **Organisations**.', correct: true },
          { id: 'b', text: 'En cliquant sur l’avatar en haut à droite.', correct: false },
          { id: 'c', text: 'En faisant défiler la page d’accueil jusqu’en bas.', correct: false },
        ],
        explanation: 'Sur mobile, la barre latérale devient un tiroir ouvert par **Ouvrir la navigation**. Voir « Se repérer dans le back-office ».',
      },
      {
        id: 'q-organisation-1',
        sectionId: 'creer-une-organisation',
        type: 'single',
        prompt: 'Vous avez fait une faute dans le nom d’une organisation que vous venez de créer. Que faites-vous ?',
        options: [
          { id: 'a', text: 'Je clique sur `Modifier` dans l’en-tête de la fiche sur le site.', correct: false },
          { id: 'b', text: 'J’ouvre la fiche de l’organisation sur la plateforme de formation et je corrige le nom.', correct: true },
          { id: 'c', text: 'Je crée une seconde organisation avec le bon nom.', correct: false },
        ],
        explanation: 'Le site ne propose pas de formulaire de modification ; la correction se fait sur la plateforme. Voir « Comment créer une organisation affiliée ou partenaire ».',
      },
      {
        id: 'q-organisation-2',
        sectionId: 'creer-une-organisation',
        type: 'true-false',
        prompt: 'Une organisation est créée automatiquement quand une personne indique un employeur inconnu à l’inscription.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Aucune création automatique : c’est vous (ou le super administrateur) qui créez la fiche. Voir « Comment créer une organisation affiliée ou partenaire ».',
      },
      {
        id: 'q-membres-1',
        sectionId: 'rattacher-un-compte',
        type: 'single',
        prompt: 'Le message « Aucun compte ne correspond à cette adresse ; créez d’abord l’utilisateur. » s’affiche. Que faites-vous ?',
        options: [
          { id: 'a', text: 'Je crée le compte avec `Nouveau compte` dans **Utilisateurs et rôles**.', correct: false },
          { id: 'b', text: 'Je vérifie l’adresse exacte du compte ; sinon j’invite la personne à s’inscrire ou je demande la création au super administrateur.', correct: true },
          { id: 'c', text: 'Je coche **Responsable** et je réessaie.', correct: false },
        ],
        explanation: 'Le compte doit exister avant le rattachement et vous ne pouvez pas le créer vous-même. Voir « Rattacher un compte existant ».',
      },
      {
        id: 'q-membres-2',
        sectionId: 'retirer-un-membre',
        type: 'multiple',
        prompt: 'Après `Retirer` sur la ligne d’un membre, qu’est-ce qui est conservé ?',
        options: [
          { id: 'a', text: 'Le compte de la personne.', correct: true },
          { id: 'b', text: 'Ses inscriptions et ses demandes de formation.', correct: true },
          { id: 'c', text: 'Sa responsabilité sur l’organisation.', correct: false },
        ],
        explanation: 'Seules l’appartenance et la responsabilité éventuelle sont retirées ; le compte et son historique restent. Voir « Retirer un membre de l’organisation ».',
      },
      {
        id: 'q-desactiver-1',
        sectionId: 'desactiver-ou-reactiver-une-organisation',
        type: 'true-false',
        prompt: 'Désactiver une organisation efface ses demandes de formation et ses cohortes.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'La désactivation masque seulement l’organisation des listes de choix ; tout est conservé et `Réactiver` la remet en service. Voir « Comment désactiver ou réactiver une organisation ».',
      },
      {
        id: 'q-demandes-1',
        sectionId: 'suivre-les-demandes-depuis-le-site',
        type: 'single',
        prompt: 'Quel délai de réponse l’accusé de réception annonce-t-il à l’organisation qui a déposé une demande ?',
        options: [
          { id: 'a', text: '48 heures.', correct: false },
          { id: 'b', text: '5 jours ouvrés.', correct: true },
          { id: 'c', text: '30 jours.', correct: false },
        ],
        explanation: 'L’email « Demande de formation … bien reçue » mentionne « sous 5 jours ouvrés ». Voir « Comment suivre les demandes de formation et les cohortes depuis le site ».',
      },
      {
        id: 'q-annuaire-1',
        sectionId: 'retrouver-un-compte',
        type: 'single',
        prompt: 'Sur la fiche d’un formateur, son rôle affiche « Expiré le … ». Que faites-vous ?',
        options: [
          { id: 'a', text: 'Je clique sur `Attribuer un rôle` sur sa fiche.', correct: false },
          { id: 'b', text: 'Je demande au super administrateur de lui attribuer le rôle à nouveau.', correct: true },
          { id: 'c', text: 'Je le rattache à une organisation comme responsable.', correct: false },
        ],
        explanation: 'L’annuaire est en consultation seule pour votre rôle ; l’attribution des rôles relève du super administrateur. Voir « Comment retrouver un compte et vérifier ses rôles ».',
      },
      {
        id: 'q-finance-1',
        sectionId: 'relancer-le-rapprochement',
        type: 'single',
        prompt: 'Un apprenant affirme avoir payé par Mobile Money il y a une heure, mais sa commande reste « En attente ». Quel bouton utilisez-vous ?',
        options: [
          { id: 'a', text: '`Rembourser`', correct: false },
          { id: 'b', text: '`Relancer le rapprochement`', correct: true },
          { id: 'c', text: '`Émettre le reçu`', correct: false },
        ],
        explanation: 'Le rapprochement re-vérifie les paiements en attente depuis plus de 15 minutes. Voir « Relancer le rapprochement des paiements ».',
      },
      {
        id: 'q-finance-2',
        sectionId: 'emettre-un-recu',
        type: 'true-false',
        prompt: 'Vous pouvez émettre le reçu d’une commande encore « En attente ».',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'Le reçu n’est émis que pour une commande réglée (Payée, Partiellement remboursée ou Remboursée). Voir « Faire émettre ou régénérer un reçu ».',
      },
      {
        id: 'q-prise-en-charge-1',
        sectionId: 'consulter-les-prises-en-charge',
        type: 'single',
        prompt: 'Une organisation finance à 100 % la formation d’un de ses membres. Comment faire appliquer cette prise en charge ?',
        options: [
          { id: 'a', text: 'Je clique sur `Nouvelle prise en charge` dans **Finance**.', correct: false },
          { id: 'b', text: 'Je transmets au rôle Finance l’email du bénéficiaire, la formation, le pourcentage, le financeur et la date de fin.', correct: true },
          { id: 'c', text: 'Je crée un code promotionnel sur la plateforme.', correct: false },
        ],
        explanation: 'La création des prises en charge est réservée au rôle Finance ; vous les consultez seulement. Voir « Comment consulter les prises en charge ».',
      },
      {
        id: 'q-rapports-1',
        sectionId: 'consulter-les-rapports',
        type: 'single',
        prompt: 'Quel est le format des exports proposés sur la page **Rapports** du site ?',
        options: [
          { id: 'a', text: 'Trois fichiers CSV (UTF-8, séparateur point-virgule), chaque export étant journalisé.', correct: true },
          { id: 'b', text: 'Un classeur Excel par cohorte.', correct: false },
          { id: 'c', text: 'Un rapport PDF mensuel envoyé par email.', correct: false },
        ],
        explanation: 'Seuls trois exports CSV existent sur le site ; les rapports par cohorte sont sur la plateforme. Voir « Comment consulter les rapports et exporter un CSV ».',
      },
      {
        id: 'q-media-1',
        sectionId: 'supprimer-un-fichier',
        type: 'true-false',
        prompt: 'Un fichier supprimé de la médiathèque peut être restauré par le super administrateur.',
        options: [
          { id: 'a', text: 'Vrai', correct: false },
          { id: 'b', text: 'Faux', correct: true },
        ],
        explanation: 'La suppression est définitive : le fichier est retiré du stockage et les contenus qui l’utilisent affichent un lien cassé. Voir « Supprimer un fichier ».',
      },
      {
        id: 'q-catalogue-1',
        sectionId: 'verifier-le-catalogue-public',
        type: 'single',
        prompt: 'Vous avez publié un cours sur la plateforme il y a deux minutes, mais il n’apparaît pas encore sur la page **Formations** du site. Que faites-vous ?',
        options: [
          { id: 'a', text: 'J’attends jusqu’à 5 minutes (la fiche est mise en cache) et je recharge la page.', correct: true },
          { id: 'b', text: 'Je saisis le cours dans le back-office du site.', correct: false },
          { id: 'c', text: 'Je contacte immédiatement le support.', correct: false },
        ],
        explanation: 'Le catalogue est alimenté automatiquement par la plateforme, avec un cache de 5 minutes. Voir « Comment vérifier une formation dans le catalogue public ».',
      },
      {
        id: 'q-aide-1',
