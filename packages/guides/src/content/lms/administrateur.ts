...
export const lmsAdministrateur: Guide = {
  ...
  selfAssessment: {
    intro:
      'Douze questions pour vérifier que vous savez où agir dans l’administration, ce qui est irréversible et à qui vous adresser. Comptez six minutes ; le corrigé renvoie à la section du guide.',
    passPercent: 70,
    questions: [
      {
        id: 'q-role-1',
