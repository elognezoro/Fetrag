...
export const lmsCoordination: Guide = {
  ...
  selfAssessment: {
    intro:
      'Quinze questions pour vérifier que vous savez où agir, ce que signifient les statuts, ce qui est irréversible et à qui vous adresser. Comptez dix minutes ; le corrigé renvoie à la section du guide.',
    passPercent: 70,
    questions: [
      {
        id: 'q-role-1',
